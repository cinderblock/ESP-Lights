...
AsyncWebServer Blinken::Networking::server(80);
AsyncWebSocket Blinken::Networking::ws("/ws");
AsyncEventSource Blinken::Networking::events("/events");

void onWsEvent(AsyncWebSocket *server, AsyncWebSocketClient *client,
               AwsEventType type, void *arg, uint8_t *data, size_t len);

void Blinken::Networking::setup() {
